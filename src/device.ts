...
export default class Device {
  ...
  protected sendPacket(buffer: Buffer, command = 0x6a): Promise<Buffer> {
    return new Promise((resolve, reject) => {
      ...
      // removed .reverse() from this.mac, beceause its also removed from discovery
      [packet[0x2a], packet[0x2b], packet[0x2c], packet[0x2d], packet[0x2e], packet[0x2f]] = this.mac;
